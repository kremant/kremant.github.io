(function ($) {
    ...
    var _self = {
            ...
            _self.settings = lightcase.settings = $.extend(
                true,
                {
                    ...
                    errorMessage: function () {
                        return (
                            '<p class="' + _self.settings.classPrefix + 'error">' + _self.settings.labels["errorMessage"] + "</p>"
                        );
                    },
                    labels: {
                    ...
                    markup: function () {
                        _self.objects.body.append(
                            ...
                            (_self.objects.case = $(
                                '<div id="' + _self.settings.idPrefix + 'case" aria-hidden="true" role="dialog"></div>'
                            ))
                        );
        ...
        _setObjectData: function (object) {
            var $object = $(object),
                objectData = {
                    ...
                    isPartOfSequence:
                        _self.settings.useAsCollection || _self._isPartOfSequence($object.attr(_self.settings.attr), ":"),
            ...
            objectData.sequenceInfo =
                objectData.currentIndex + 1 + _self.settings.labels["sequenceInfo.of"] + objectData.sequenceLength;
        ...
        _determineLinkTarget: function () {
            return (
                _self.settings.href || $(_self.origin).attr(_self._prefixAttributeName("href")) || $(_self.origin).attr("href")
            );
        },
        ...
        isSlideshowEnabled: function () {
            return (
                ...
                (_self.settings.slideshow === true || _self.objectData.isPartOfSequenceWithSlideshow === true)
            );
        },
        ...
        _calculateDimensions: function ($object) {
            ...
            if (!_self.settings.disableShrink) {
                ...
                switch (_self.objectData.type) {
                    ...
                    case "inline":
                        if (_self.objectData.type === "image" || _self.settings.fixedRatio === true) {
                            if (
                                ...
                                dimensions.differenceWidthAsPercent > dimensions.differenceHeightAsPercent
                            ) {
                                dimensions.objectWidth = dimensions.maxWidth;
                                dimensions.objectHeight = parseInt(
                                    (dimensions.objectHeight / dimensions.differenceWidthAsPercent) * 100
                                );
                            }
                            if (
                                dimensions.differenceHeightAsPercent > 100 &&
                                dimensions.differenceHeightAsPercent > dimensions.differenceWidthAsPercent
                            ) {
                                dimensions.objectWidth = parseInt(
                                    (dimensions.objectWidth / dimensions.differenceHeightAsPercent) * 100
                                );
                    ...
                    default:
                        if (
                            (isNaN(dimensions.objectWidth) || dimensions.objectWidth > dimensions.maxWidth) &&
                            !_self.settings.forceWidth
                        ) {
                            dimensions.objectWidth = dimensions.maxWidth;
                        }
                        if (
                            ((isNaN(dimensions.objectHeight) && dimensions.objectHeight !== "auto") ||
                                dimensions.objectHeight > dimensions.maxHeight) &&
